...
void brightUp() {
  for (int i = 0; i < STEPS; i++) {
    TrinketHidCombo.pressKey(KEYCODE_MOD_LEFT_SHIFT | KEYCODE_MOD_LEFT_ALT, KEYCODE_F15);
...
void brightDn() {
  for (int i = 0; i < STEPS; i++) {
    TrinketHidCombo.pressKey(KEYCODE_MOD_LEFT_SHIFT | KEYCODE_MOD_LEFT_ALT, KEYCODE_F14);
    TrinketHidCombo.pressKey(0, 0);
  }
}
